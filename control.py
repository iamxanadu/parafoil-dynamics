from numpy import cos, radians, sin, sqrt, atan2, exp, clip, arcsin
from numpy import meshgrid, linspace, zeros_like
import matplotlib.pyplot as plt


class GeometricController():
    def __init__(self, r0=30, umax=1.0, ht=100, P_gamma=1.0):
        self.r0 = r0  # [m]
        self.umax = umax
        self.ht = ht
    ...
    def u(self, x: list, mu: float):

        u = self.geometricYawControl(x)
        c_sigma = self.calcSigmaFromPsiDot(x, u, mu)
